...
function Field({ label, v, setV, placeholder, multiline }) {
...
function Icon({ name }) {
  ...
  if (name === "pin")   return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={sw}><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>;
  return null;
}

function ContactRow({ icon, label, action, onAction }) {
  return (
