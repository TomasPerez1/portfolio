...
export function StackTicker() {
  const items = ["React","Next.js","TypeScript","Tailwind","Node.js","NestJS","Express","PostgreSQL","MySQL","Prisma","Sequelize","Docker","GitHub Actions","Auth0","Three.js","Redis"];
  return (
...
export function SectionHeader({ index, kicker, title, hint }) {
  return (
